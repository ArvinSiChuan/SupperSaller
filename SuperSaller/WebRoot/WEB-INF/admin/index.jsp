	...
	<section id="main" class="wrapper" style="width: 70%;">
		...
		<div id="goodListDiv" style="margin-left: 2.2em;margin-top: 1em;">
			<table id="goodListTable" class="table-wrapper">
				...
				<tfoot>
					<tr id="addNewGood">
						<td name="newGood"><input name="newGood" type="text"
							pattern="[0-9]*" placeholder="商品数字号" /> <input name="history"
							type="hidden" />
							<div name="possibleGoods" style="width: 100%;">
								<a href="#newGood" class="button small fit"
									onclick="foucusNewGoodBox();">☝填写商品代码</a>
							</div></td>
						<td name="goodName"></td>
						<td name="goodBrand"></td>
						<td name="goodNums"><input name="goodNumAdd"
							class="small fit" type="button" value=" + " /> <input
							name="goodNums" type="number" min="1" value="1"
							style="width: 100%;margin-bottom: 0.7em;" /> <input
							name="goodNumRemove" class="small fit" type="button" value=" - " />
						</td>
						...
						<td name="subTotal"></td>
						<td name="comments"></td>
						<td><input id="addToGoodListBtn" type="button" class="fit"
							value="添加" /></td>
					</tr>
				</tfoot>
			</table>
